...
for (let games of topSellers) {
  ...
  container.style.backgroundColor = "rgb(226, 226, 92)";
  ...
  // Div with information about games
  const infoContainer = document.createElement("div");
  infoContainer.classList.add("info-container");
  // infoContainer.style.backgroundColor = "rgba(237, 18, 18, 0.706)";

  // Developer
  const develop = document.createElement("p");
  develop.textContent = `Company: ${games.developer}`;
  ...
  container.append(image, titleG, descrip, infoContainer);

  // Append to section
  gameContainer.append(container);

  // gameContainer.style.backgroundColor = "rgb(225, 130, 130)";
}

// Doing vide games list
...
containrist.style.margin = "1rem 2rem";
// append to list
